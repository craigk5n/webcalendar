...
#   E: Reminder sent
# cal_log_id: unique id for entry
# cal_entry_id: event id in webcal_entry
# cal_login: user who performed action
# cal_user_cal: user who's calendar was affected
# cal_date: date in YYYYMMDD format
# cal_time: time in HHMM format
# cal_text: option text
