...
ALTER TABLE webcal_entry_repeats_not ADD cal_exdate int(1);
...
ALTER TABLE webcal_entry_user ADD cal_percent int(11);
UPDATE webcal_entry_user SET cal_percent = '0';
ALTER TABLE webcal_entry_user ALTER cal_percent SET DEFALT '0';
...
ALTER TABLE webcal_user ALTER cal_enabled DEFAULT 'Y';
