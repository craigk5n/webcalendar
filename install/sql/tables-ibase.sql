...
CREATE TABLE WEBCAL_BLOB (
  ...
  CAL_ID INTEGER NULL,
  CAL_LOGIN VARCHAR(25) CHARACTER SET WIN1252 NULL,
  CAL_NAME VARCHAR(30) CHARACTER SET WIN1252 NULL,
  CAL_DESCRIPTION VARCHAR(128) CHARACTER SET WIN1252 NULL,
  CAL_SIZE INTEGER NULL,
  CAL_MIME_TYPE VARCHAR(50) CHARACTER SET WIN1252 NULL,
