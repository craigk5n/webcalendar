...
$install_sql = array (
  ...
  array ( 'name'=>'access_user',
   ...
   'primary'=>array ( 'cal_login_id', 'cal_other_user_id' )
  ),
  ...
  array ( 'name'=>'categories',
   ...
   'fields'=>array (
     ...
     array ( 'cat_icon', VARCHAR, 50, Y, NULL ),
    ),
  ...
  'primary'=>array ( 'cal_id', 'cal_fullname' )
  ),
  ...
  'primary'=>array ( 'cal_id', 'cal_login_id' )
  ),
  ...
  'primary'=>array ( 'cal_group_id', 'cal_login_id' )
  ),
  ...
  'primary'=>array ( 'cal_id', 'cal_import_id' )
  ),
  ...
  array ( 'name'=>'user_layers',
   ...
   'fields'=>array (       
     ...
     array ( 'cal_login_id', INT, 11, N ),       
     array ( 'cal_layeruser_id', INT, 11, N ),       
     array ( 'cal_color', VARCHAR, 7, Y ),       
  ...
  'primary'=>array ( 'cal_login_id', 'cal_type' )
  ),
  ...
  'primary'=>array ( 'cal_view_id', 'cal_login_id' )
  )
);
