...
<tr><td><b><?php etranslate("Document background")?>:</b></td>
  <td><input name="admin_BGCOLOR" size="8" maxlength="7" value="<?php echo $s["BGCOLOR"]; ?>"></td><td bgcolor="<?php echo $s["BGCOLOR"]?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="button" onclick="selectColor('admin_BGCOLOR')" value="<?php etranslate("Select")?>..." name="" /></td></tr>
