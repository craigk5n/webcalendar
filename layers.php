        ...
        <div class="modal-body">
          <form name="editLayerForm" id="editLayerForm">
            ...
            <div class="modal-footer">
              ...
              <input class="form-control btn btn-danger" id="editLayerDeleteButton" type="button" value="<?php etranslate("Delete"); ?>" onclick="if ( confirm ( '<?php echo $areYouSureStr; ?>' ) ) {
            $('#editLayerDelete').prop ('value', '1');
            edit_window_closed ();
            $('#edit-layer-dialog').hide();
            }" />
              <input class="form-control btn btn-primary" data-dismiss="modal" type="button" value="<?php etranslate("Save"); ?>" onclick="edit_window_closed(); $('#edit-layer-dialog').hide();" />
            </div>
          </form>
        </div>
      </div>
