...
<?php
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;
  <input id="enablebutton" type="button" value=<?php echo $enableLayersStr;?>" onclick="return set_layer_status(true);" <?php echo ( $layers_enabled ? 'disabled="true"' : '' );?>>
  <input id="disablebutton" type="button" value=<?php etranslate ( 'Disable Layers' );?>" onclick="return set_layer_status(false);" <?php echo ( $layers_enabled ? '' : 'disabled="true"' );?>>
  </div>
...
<div id="editLayerDiv" style="display: none;">
  ...
  <form name="editLayerForm" id="editLayerForm">
    <input id="editLayerId" name="editLayerId" type="hidden" value="">
    <input id="editLayerDelete" name="editLayerDelete" type="hidden" value="0">
    <table>
      ...
      <tr><td class="tooltip" title="<?php etranslate('If checked, events that are duplicates of your events will be shown.');?>"><label><?php echo $duplicatesStr;?>:</label></td>
        <td><input id="editLayerDups" name="editLayerDups" type="checkbox">
        </td></tr>
    </table>
    <br>
    <center>
