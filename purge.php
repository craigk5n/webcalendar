...
<option value="ALL"><?php echo $allStr ?></option>
 ...
 <tr><td><label for="purge_all" class="colon">
  ...
  <input id="purge_all" name="purge_all" type="checkbox" value="Y" onclick="toggle_datefields('dateArea', this);">
 </td></tr>
 ...
 <tr><td><label for="purge_deleted" class="colon">
  ...
  <td class="alignbottom">
  <input name="purge_deleted" type="checkbox" value="Y">
 </td></tr>
 <tr><td><label for="preview" class="colon">
  <?php etranslate ( 'Preview delete' )?></label></td>
  <td class="alignbottom">
  <input checked name="preview" type="checkbox" value="Y">
 </td></tr>
 <tr><td colspan="2">
