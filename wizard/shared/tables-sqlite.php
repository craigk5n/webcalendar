 ...
 */
 function populate_sqlite_db ( $database, $db ) {
   ...
   // backdoor. The installer now requires a real, hashed admin password.
   ...
   sqlite_query($db, "INSERT INTO webcal_config ( cal_setting, cal_value ) VALUES ( 'WEBCAL_PROGRAM_VERSION', 'v1.9.17' );");
