 ...
 *
 * File Description:
 *	This file loads configuration settings from the data file
 *	settings.php and sets up some needed variables.
 *
 *	The settings.php file is created during installation using
 *	the web-based db setup page (install/index.php).
 *
 * Note:
...
$PROGRAM_VERSION = "v1.0RC1";
$PROGRAM_DATE = "04 Feb 2005";
