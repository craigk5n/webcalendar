...
function print_color_input_html ($varname, $title, $varval = '', $id='', $tag='div', $class='form-inline', $onchange = '') {
  ...
  //  '<input class="form-control" style="block-size: 2em; inline-size: 4em;" name="' . $varname . '" id="' . $id .
  ...
  (empty($title) ? '' : ('<label class="' . $class . '" for="' . $prefix . $varname . '">' . $title . '</label>')) .
    '<input class="form-control" style="block-size: 2em; inline-size: 4em;" name="' . $prefix . $varname . '" id="' . $prefix . $id .
