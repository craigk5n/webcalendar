...
/* Define your custom menu items using the syntax below
   ...
   parameters marked with * are optional
       menu, title, url*, [item, submenu, divider, spacer]
       item, icon, title*, url*, target*
       submenu, icon, title, [item, submenu, divider, spacer]
       divider
       spacer
...
$menuExtras[2] = ['menu', 'My Example', '',
  [
    ['item', 'todo.png', 'New Todo', 'edit_entry.php?eType=task', ''],
    ['item', 'week.png', 'View Week', 'week.php', ''],
    ['divider'],
    ['submenu', 'manage_cal.png', 'External Links',
      [
        ['item', 'display.png', 'Google', 'http://www.google.com', '_blank'],
        ['item', 'display.png', 'Craig&#39;s Site',
...
$request_url = $base_url . "&date=" . htmlspecialchars($_GET["date"]);
}
