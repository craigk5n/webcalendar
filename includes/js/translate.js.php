...
echo 'var bydayLabels= [' . $tmp1 . '],
bydayTrans     = [' . $tmp2 . '],
months         = [' . $tmpm . '],
shortMonths    = [' . $tmpsm . '],
shortWeekdays  = [' . $tmpsw . '],
userSvrTZ      = \'' . date ( 'e' ) . '\', // testing for User Server TZ
userSvrTZAbbr  = \'' . date ( 'T' ) . '\', // testing for User Server TZ Abbreviation
weekdays       = [' . $tmpw . '],
xlate          = [];

xlate[\'AMPMampm\']           = \'' . translate ( 'AMPMampm', true ) . '\';
xlate[\'AM\']                 = \'' . translate ( 'AM', true ) . '\';
xlate[\'Categories\']         = \'' . translate ( 'Categories', true ) . '\';
xlate[\'DST\']                = \'' . translate ( 'DST', true ) . '\';
xlate[\'DSTstd\']             = \'' . translate ( 'DSTstd', true ) . '\';
xlate[\'Hide\']               = \'' . translate ( 'Hide', true ) . '\';
xlate[\'JSONerrXXX\']         = \'' . translate ( 'JSON error XXX', true ) . '\';
xlate[\'PM\']                 = \'' . translate ( 'PM', true ) . '\';
...
xlate[\'remove\']             = \'' . translate ( 'Remove', true ) . '\';
xlate[\'reqServerURL\']       = \'' . translate ( 'Server URL is required.', true ) . '\';
xlate[\'st\']                 = \'' . translate ( 'st', true ) . '\';
xlate[\'std\']                = \'' . translate ( 'std', true ) . '\';
xlate[\'stndrdth\']           = \'' . translate ( 'stndrdth', true ) . '\';
xlate[\'th\']                 = \'' . translate ( 'th', true ) . '\';
