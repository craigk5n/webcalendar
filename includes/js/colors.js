...
// Predefined Colors
  var
    ...
    // Color choices
    colorList = ['0', 'ff0000', '400000', '800000', 'c00000', 'ff4040',
      'ff8080', 'ffc0c0', '000000', 'ffff00', '404000', '808000', 'c0c000',
      'ffff40', 'ffff80', 'ffffc0', '202020', '00ff00', '004000', '008000',
      '00c000', '40ff40', '80ff80', 'c0ffc0', '404040', '00ffff', '004040',
      '008080', '00c0c0', '40ffff', '80ffff', 'c0ffff', '808080', '0000ff',
      '000040', '000080', '0000c0', '4040ff', '8080ff', 'c0c0ff', 'c0c0c0',
      'ff00ff', '400040', '800080', 'c000c0', 'ff40ff', 'ff80ff', 'ffc0ff',
      'ffffff'],
...
function fillhtml() {
  ...
  for ( var i = 1; i < 193; i++ ) {
    slidehtml +=
      '<tr><td id="sc' + i + '" height="1" width="14"></td></tr>' + nl;
  }
  slide.innerHTML = slidehtml + '</table>' + nl;

  for ( var i = 1; i < 7; i++ ) {
    choicehtml += '<tr height="14">' + nl;
    for ( var j = 1; j < 9; j++ ) {
      ctr++;
      choicehtml += '<td height="14" width="14" bgcolor="#' + colorList[ctr]
      + '" onclick="setCol( \'' + colorList[ctr] + '\' )">'
      + '<img src="images/blank.gif" style="width:14px; height:14px;" '
      + 'alt=""></a></td>' + nl;
    }
    choicehtml += '</tr>' + nl;
  }
  choice.innerHTML = choicehtml + '</table>' + nl;

  for ( var i = 1; i < 17; i++ ) {
    customhtml += '<td id="precell' + i
       + '" bgcolor="#ffffff" onclick="preset( ' + i
       + ')"><img src="images/blank.gif" id="preimg' + i + '" style="width:14px; height:14px;" alt=""></td>' + nl;
    if ( i == 8 ) {
      customhtml += '</tr>' + nl + '<tr>';
    }
  }
...
function transferColor() {
  ...
  thisInput.value =
    '#' + document.getElementById( 'htmlcolor' ).value.toUpperCase();
