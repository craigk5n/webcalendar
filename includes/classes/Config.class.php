<?php
/**
 *   This class provides a convenient way to load and access system
 * and user preferences without to test for existance.
 *
 * @author Ray Jones
...
/**
 * A  object.  This can represent an event attachment or
