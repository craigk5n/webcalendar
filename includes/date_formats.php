 ...
 *  valid codes example
 *    __mm__    = 01-12 (leading zero)
 *    __m__     = 1-12 (no leading zero)
 *    __month__ = December
 *    __mon__   = Dec
 *    __dd__    = 01-31 (leading zero )
 *    __d__     = 1-31 ( no leading zero)
 *    __yyyy__  = 2005
 *    __yy__    = 05
 *
 *
...
$smarty->assign ( 'datestyles', array ( 'LANGUAGE_DEFINED'=>$langDefStr,
  '__mon__ __d__, __yyyy__'=>$DecStr . ' 5, 2000',
...
// Month Year format
$smarty->assign ( 'datestyles_my', array ( 'LANGUAGE_DEFINED'=>$langDefStr,
...
// Month Day format
$smarty->assign ( 'datestyles_md', array ( 'LANGUAGE_DEFINED'=>$langDefStr,
...
// Task Date format
$smarty->assign ( 'datestyles_task', array ( 'LANGUAGE_DEFINED'=>$langDefStr,
  '__mon__ __dd__'=>$DecStr . ' 31',
  '__dd__ __mon__'=>' 31' . $DecStr,
  '__dd__.__mm__'=>'31.12',
  '__dd__/__mm__'=>'31/12',
