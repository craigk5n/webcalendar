...
/**
  * Represents a log entry in the activity log.
  * We extend the vector class because the JTable swing component
  * can easily make use of a Vector for a row.
  */
public class ActivityLog extends Vector {
  ...
  /**
    ...
    * (which corresponds to the <log> tag).
    */
  ...
  {
    switch ( type ) {
      case 'C': return "Event created";
      case 'A': return "Event approved";
      case 'X': return "Event rejected";
      case 'U': return "Event updated";
      case 'D': return "Event deleted";
      case 'N': return "Notification sent";
      case 'R': return "Reminder sent";
      case 'F': return "New user via self-registration";
      case 'E': return "New user via email";
  ...
  public Object elementAt ( int i )
  {
    switch ( i )
    {
      case 0: return getUser ();
      case 1: return getCalendarUser ();
      case 2: return dateTime;
      case 3: return getType ();
      case 4: return getAction ();
      default: return "-";
    }
  }
