 ...
 *
 * Description:
 *	WebCalendar reminder application - Queries the WebCalendar server
 *	to get a list of upcoming reminders and then displays them at
 *	the proper time.
 *
 */
...
/**
  * WebCalendar Web Services client for displaying event reminders.
  * Queries the WebCalendar server
  * to get a list of upcoming reminders and then displays them at
  * the proper time.
  */
  ...
  public static void main(String[] args) {
    ...
    for ( int i = 0; i < args.length; i++ ) {
      if ( args[i].startsWith ( "-url=" ) ) {
        ...
        System.err.println (
          "Usage: java ReminderApp [options]" );
    ...
    ReminderLoader loader = new ReminderLoader ( client, display,
      reloadMinutes );
    loader.start ();
