 ...
 *
 * Description:
 *	WebCalendar client application
 *
 */
...
/**
  * WebCalendar Web Services client.
  */
public class SampleApp
  ...
  public static void main(String[] args) {
    ...
    int reloadReminderMinutes = 15; // how often to get updated list of reminders
    ...
    ReminderLoader rloader = new ReminderLoader ( client,
      reminderDisplay, reloadReminderMinutes );
    rloader.start ();
