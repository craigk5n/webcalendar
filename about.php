...
print_header ( '', ( empty ( $credits ) ? '' : '<script>
    ...
    <script src="includes/js/v_h_scrolls.js?'
...
echo '    <div id="creds">' . ( empty( $credits ) ? '
      <a href="' . $PROGRAM_URL . '" target="_blank" title="' . $PROGRAM_NAME . '">
      <h2>' . translate( 'Title' ) . '</h2>
      <p>' . translate ( $PROGRAM_VERSION,0,'N' ) . '<br>
      ' . translate ( $PROGRAM_DATE,0,'D' ) . '</p></a><br>
