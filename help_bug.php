...
$rptBugStr = translate( 'Report Bug' );
...
echo $helpListStr . '
    <h2>' . $rptBugStr . '</h2>
    <p>' . translate( 'include info to report bugs' )
 . ( $LANGUAGE != 'English-US' ? ' '
   . str_replace( 'XXX', translate( get_browser_language( true ) ),
    ...
    <form action="http://sourceforge.net/tracker/" target="_new">
      ...
      <input type="submit" value="' . $rptBugStr . '">
    </form>
    <h3>' . translate( 'System Settings' ) . '</h3>
    <div>';
// Since these are literals and not translated,
// the punctuation either has to stay here or not show at all.
$tmp_arr = array(
