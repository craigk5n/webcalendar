...
if ( ! _WC_SINGLE_USER && $WC->isAdmin() ) {
  ...
  $users = array();
	...
	$users[$WC->loginId()]['selected'] = ' selected="selected"';
...
build_header ( array ( 'export_import.js', 'visible.js' ) );

$smarty->assign ( 'exportSelectStr', generate_export_select ('toggel_catfilter') );
